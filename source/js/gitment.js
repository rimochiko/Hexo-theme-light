...
function renderHeader(_ref, instance) {
  ...
  commentsCount.innerHTML = '\n    ' + (meta.comments ? ' \u2022 <strong>' + meta.comments + '</strong> 添加评论' : '') + '\n  ';
